/*
Sprint 4 — Approval Center + Pending Approval Inbox.
This page centralizes final approval requests generated by phase gates.
*/
...
export default function ApprovalCenter() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        eyebrow="Sprint 4 / Controlled sign-off"
